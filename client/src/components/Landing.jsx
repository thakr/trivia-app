...
export default function Landing() {
  ...
  return (   
    ...
    </div><p className="mt-4 cursor-pointer" onClick={() => setButtonInput(!buttonInput)}>← Go back</p></>: <><motion.div className="flex items-center text-center sm:flex-col" initial={{opacity: 0}} animate={{opacity: 1}}>
    ...
    <motion.p className="mt-10 text-center mx-4 text-gray-700" initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration:0.5}}>triviahit is an online multiplayer trivia game where players answer a series of 10 questions and compete to get the best score.</motion.p>
